...
@section('title', 'Admin Dashboard - Le Nium Legal')
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-md transition-shadow">
        ...
        <a href="{{ route('admin.cancellation-requests') }}" class="text-xs text-blue-600 hover:text-blue-700 font-semibold mt-4 inline-block">View requests →</a>
    </div>
</div>
...
<div class="bg-white rounded-lg border border-gray-200 p-6 mb-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <a href="{{ route('admin.messages.inbox') }}" class="p-4 border-2 border-blue-200 rounded-lg hover:bg-blue-50 text-center transition-colors group">
        ...
        <a href="{{ route('admin.messages.create.broadcast') }}" class="p-4 border-2 border-purple-200 rounded-lg hover:bg-purple-50 text-center transition-colors group">
        ...
        <a href="{{ route('admin.export.clients.csv') }}" class="p-4 border-2 border-green-200 rounded-lg hover:bg-green-50 text-center transition-colors group">
