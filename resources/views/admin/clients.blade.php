    ...
    <div class="flex gap-3 items-center">
        <div class="relative group">
            ...
            <div class="hidden absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 group-hover:block z-50">
                <a href="{{ route('admin.export.clients.csv') }}" class="block px-4 py-3 text-sm text-gray-700 hover:bg-blue-50 border-b border-gray-100">
                    <span class="font-semibold">📊 Export as CSV</span>
                    <p class="text-xs text-gray-500">Spreadsheet format</p>
                </a>
                <a href="{{ route('admin.export.clients.excel') }}" class="block px-4 py-3 text-sm text-gray-700 hover:bg-blue-50 border-b border-gray-100">
                    <span class="font-semibold">📈 Export as Excel</span>
                    <p class="text-xs text-gray-500">XLSX format</p>
                </a>
                <a href="{{ route('admin.export.clients.pdf') }}" class="block px-4 py-3 text-sm text-gray-700 hover:bg-blue-50">
