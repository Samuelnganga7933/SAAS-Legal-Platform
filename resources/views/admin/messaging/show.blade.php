...
@section('title', 'Message - Admin Portal')
...
<div class="bg-white rounded-lg border border-gray-200 overflow-hidden">
    ...
    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-gray-200 p-6">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="text-right">
                <span class="inline-block px-3 py-1 bg-blue-100 text-blue-700 text-xs font-semibold rounded-full">Client Message</span>
    ...
    <div class="bg-gray-50 border-t border-gray-200 p-6 flex items-center justify-between">
        ...
        <div class="flex gap-3">
            <a href="{{ route('admin.messages.create.direct') }}" class="px-4 py-2 bg-blue-600 text-white font-semibold text-sm rounded-lg hover:bg-blue-700 transition-colors">
                Send Reply
            </a>
            <a href="{{ route('admin.messages.inbox') }}" class="px-4 py-2 border border-gray-300 text-gray-700 font-semibold text-sm rounded-lg hover:bg-gray-50 transition-colors">
                Back to Inbox
            </a>
        </div>
    </div>
