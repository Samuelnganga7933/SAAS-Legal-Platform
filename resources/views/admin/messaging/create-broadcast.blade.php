...
@section('title', 'Send Broadcast - Admin Portal')

@section('content')
<!-- Page Header -->
<div class="mb-8">
    <a href="{{ route('admin.messages.inbox') }}" class="text-purple-600 hover:text-purple-700 text-sm font-semibold mb-3 inline-flex items-center gap-1">
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
    ...
    <div class="lg:col-span-2">
        ...
        <div class="bg-white rounded-lg border border-gray-200 shadow-sm">
            ...
            <!-- Form Body -->
            <form action="{{ route('admin.messages.send.broadcast') }}" method="POST" class="p-8 space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <input 
                        ...
                        value="{{ old('subject') }}"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent transition @error('subject') border-red-500 @enderror"
                        required
                    >
                    @error('subject')
                ...
                <div>
                    ...
                    <textarea 
                        ...
                        rows="8"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent transition resize-none @error('body') border-red-500 @enderror"
                        required
                    >{{ old('body') }}</textarea>
                    @error('body')
                        <p class="text-red-600 text-sm mt-2">{{ $message }}</p>
