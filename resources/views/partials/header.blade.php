    ...
    <nav class="container mx-auto px-4 py-4">
        <div class="flex items-center justify-between">
            ...
            <div class="hidden lg:flex items-center gap-6">
                ...
                <a href="{{ route('login') }}" class="text-gray-700 hover:text-blue-600 transition-colors">Sign In</a>
        ...
        <div class="hidden mobile-menu lg:hidden mt-4 pb-4 flex flex-col gap-4">
            ...
            <a href="{{ route('login') }}" class="text-left text-gray-700 hover:text-blue-600 transition-colors py-2">Sign In</a>
            <a href="#contact" class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors">Book a Call</a>
        </div>
    </nav>
